############################################################################
#
# ResizeRemoveVhdxDisk.ps1
#
# This script uses the PowerShell Hyper-V snap-in which started shipping
# with Windows 8.  This script must be run on a Win 8 system.
#
# Description:
...
#
#     <testParams>
#         <param>SCSI=0,0,Fixed,4096</param>
...
#
#       "SCSI=0,0,Fixed,4096;IDE=0,1,Dynamic,512"
#
...
function DeleteHardDrive([string] $vmName, [string] $hvServer, [string]$controllerType, [string] $arguments)
{
    ...
    if ($fields.Length -lt 3 -or $fields.Length -gt 4)
    {
