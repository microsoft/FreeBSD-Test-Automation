...
if ($? -ne "True")
{
write-host "Error while creating VM snapshot"
return $retVal
}

Start-Sleep -Seconds 4

Get-VMSnapshot -Server $hvServer -vm  $VmName -Current | Rename-VMSnapshot -newname $Snapshot -Force
if ($? -eq "True")
{
$retVal = $True
return $retVal
...
{
write-host "Error while renaming VM snapshot"
return $retVal
}