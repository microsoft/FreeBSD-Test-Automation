...
a VM, ``TestVM``, then you can start a damned
...
``NOTE`` The `wait` attribute may be dangerous, that it makes icadaemon
hang if a command must run for a long time. Use it at your own risk.
...
* Jul. 22, 2014
  ...
  - Adding preliminary support for FreeBSD 10 - likezh
