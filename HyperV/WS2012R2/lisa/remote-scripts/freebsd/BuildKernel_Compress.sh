...
#
# Remove freebsd-current.tar.bz2
#
rm -rf ~/freebsd-current.tar.bz2
if [ $? -ne 0 ]; then
    LogMsg "Error: Unable to delete file freebsd-current.tar.bz2"
else
    LogMsg "freebsd-current.tar file deleted successfully"
fi
#
# Build the kernel
#
...
#
# Set a boot option to disable Fast IDE support
#
