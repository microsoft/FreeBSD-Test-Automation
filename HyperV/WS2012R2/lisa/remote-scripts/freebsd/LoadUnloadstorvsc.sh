#!/bin/bash
#
# LoadUnloadstorvsc.sh
#
# Description:
#    To load-unload storvsc module
#    
...
#
# Unload storvsc modules and load it again
#
i=1
while [ $i -le 5 ]
do
kldunload hv_storvsc
if [ $? -ne 0 ] ; then
...
#
echo "Loading/Unloading storvsc successful" >> ~/summary.log
